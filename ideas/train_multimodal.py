...
class MultiModalLLM(nn.Module):
    ...
    def forward(self, input_embeddings, target_texts=None):
        ...
        if target_texts is not None:
            ...
            # Inference mode
            encoder_outputs = self.t5_model.encoder(inputs_embeds=projected_embeddings)
...
def train_multimodal_llm(
    ...
    model = MultiModalLLM(input_dim=input_dim, model_name=model_name).to(device)
